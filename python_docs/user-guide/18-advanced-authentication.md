...
Asok includes a granular Role-Based Access Control system. While primarily used by the [Admin Interface](../advanced/30-admin-interface.md), it is available for use in any part of your application.
...
### Enabling 2FA
The built-in Admin interface provides a complete flow for enabling and verifying 2FA. See the [Admin 2FA documentation](../advanced/30-admin-interface.md#%F0%9F%94%90-two-factor-authentication-2fa) for details.
