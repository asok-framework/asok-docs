...
app.config["CORS_ORIGINS"] = "*"
```
For more advanced scenarios, see the [CORS & Gzip Guide](../user-guide/21-cors-gzip.md).
...
See the [Serialization Guide](../user-guide/15-serialization.md) for full details on building Schemas.
